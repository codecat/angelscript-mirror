...
bool Test()
{
	...
	if( out.buffer != "TestConstProperty (5, 1) : Info    : Compiling void Init()\n"
	                  "TestConstProperty (7, 10) : Error   : Reference is read-only\n"
	                  "TestConstProperty (8, 10) : Error   : Reference is read-only\n"
	                  "TestConstProperty (9, 11) : Error   : Reference is read-only\n" )
	{
