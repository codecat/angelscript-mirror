...
protected:
	...
	asCObjectProperty *AddPropertyToClass(sClassDeclaration *c, const asCString &name, const asCDataType &type, bool isPrivate, bool isInherited, asCScriptCode *file = 0, asCScriptNode *node = 0);
