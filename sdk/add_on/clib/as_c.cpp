...
AS_API int                asEngine_GetRegisteredGlobalPropertyCount(asIScriptEngine *e)                                                                                                            { return e->GetRegisteredGlobalPropertyCount(); }
AS_API int                asEngine_GetRegisteredGlobalProperty(asIScriptEngine *e, asUINT index, const char **name, int *typeId = 0, void **pointer = 0, int *length = 0)                          { return e->GetRegisteredGlobalProperty(index, name, typeId, pointer, length); }
