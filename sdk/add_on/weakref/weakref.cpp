...
void RegisterScriptWeakRef_Native(asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectBehaviour("weakref<T>", asBEHAVE_IMPLICIT_REF_CAST, "T@ f()", asMETHOD(CScriptWeakRef, Get), asCALL_THISCALL);
	...
	r = engine->RegisterObjectBehaviour("const_weakref<T>", asBEHAVE_IMPLICIT_REF_CAST, "const T@ f()", asMETHOD(CScriptWeakRef, Get), asCALL_THISCALL);
...
void RegisterScriptWeakRef_Generic(asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectBehaviour("weakref<T>", asBEHAVE_IMPLICIT_REF_CAST, "T@ f()", asFUNCTION(CScriptWeakRef_Get_Generic), asCALL_GENERIC);
	...
	r = engine->RegisterObjectBehaviour("const_weakref<T>", asBEHAVE_IMPLICIT_REF_CAST, "const T@ f()", asFUNCTION(CScriptWeakRef_Get_Generic), asCALL_GENERIC);
