...
\note Although delegates use the asIScriptFunction interface, they are not actual functions. Because of this they are not owned by anymodule, i.e. \ref asIScriptFunction::GetModule "GetModule" will always return null. Likewise they do not have a specific function id, i.e. \ref asIScriptFunction::GetId "GetId" will return 0. 
