...
\todo Update this to reflect the automatic garbage collection
...
This may not be enough for all applications though, as some scripts may produce more garbage than others. Performing the 
