...
bool Test()
{
	...
	if( stream.buffer.size() != 1430 ) 
	{
		printf("The saved byte code is not of the expected size 1430. It is %d bytes\n", stream.buffer.size());
	}
	asUINT zeroes = stream.CountZeroes();
	if( zeroes != 396 ) 
	{
		printf("The saved byte code contains a different amount of zeroes than the expected 396. Counted %d\n", zeroes);
	...
	asBYTE expected[] = {0x00,0x00,0x00,0x00,0x00,0x01,0x66,0x6E,0x01,0x66,0x00,0x40,0x4E,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x02,0x3F,0x0A,0x00,0x00,0x00,0x00,0x02,0x00,0x70,0xC0,0x00,0x01,0x00,0x6E,0x06,0x73,0x63,0x72,0x69,0x70,0x74,0x01,0x72,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
	bool match = true;
